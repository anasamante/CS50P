...
E=mc2, wherein E represents energy (measured in Joules),
...
integer (in kilograms) and then outputs the equivalent number of Joules as an integer. Assume that
...
def convert(mass):
    print("E: ", int(mass)*pow(300000000,2))
